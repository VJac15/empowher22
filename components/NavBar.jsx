  ...
  return (
    <div className="nav-container" data-testid="navbar" class="nav-container">
      <Navbar light expand="md">
            <Nav className="mr-auto" navbar data-testid="navbar-items" class = "nav">
              <NavItem>
                <PageLink href="https://metrohacks.org/" className="nav-link" testId="navbar-home" class = "item">
                  <img src = "https://raw.githubusercontent.com/MetroHacks/EmpowHer/master/empowher-assets/img/logo.png" width = "50px"></img>
                </PageLink>
              </NavItem>
              <NavItem>
